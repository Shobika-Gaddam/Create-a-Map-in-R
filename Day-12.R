...
datacov <- read_csv("C:/Users/shobi/OneDrive/Desktop/Woxsen/Term 2/R Programming/covid19.csv.csv")
...
ggplot() +
  ...
  labs(caption = "Data Repository provided by Johns Hopkins CSSE. Visualization by DataScience Students of Woxsen University") +
  theme(
